...
/**
 * Active Directory Application Mode datasource authentication library
 */
 ...
 */
function sumo_verify_datasource_connection($id=false)
{
	GLOBAL $SUMO;
	...
	{		
		...
		if(!$datasource['port']) $datasource['port'] = 389;
							
		// $ds is a valid link identifier for a directory server	
		$ds = ldap_connect($datasource['host'], $datasource['port']);
