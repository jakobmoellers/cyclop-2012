...
require SUMO_PATH."/libs/lib.datasource.postgres.php";

/*
// Verify if PostgreSQL extension is loaded
if(!in_array('mysql', get_loaded_extensions())) 
	$sumo_access='POSTGRESMODULEERROR';
else
*/
if($_SESSION['loggedin'] == false && !$sumo_verify_datasource_connection($SUMO['user']['datasource_id']))
	$sumo_access='POSTGRESCONNECTIONFAILED';
// Verify Password via PostgreSQL
