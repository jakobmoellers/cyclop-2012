...
<html>
 <head>
  ...
  <link rel='StyleSheet' media='screen' type='text/css' href='{{GET:PagePath}}/themes/{{GET:PageTheme}}/css/style.css'>
 ...
 <!-- Menu Top -->
    <table class='menu-top'>
     <tr>
      <td valign='top' style='padding-top: 2px; padding-left: 5px'><img src='{{GET:PagePath}}/themes/{{GET:PageTheme}}/images/sumo_logo_menu.gif' alt='SUMO'></td>      
      ...
      <td valign='top' style='padding-top: 4px; padding-left: 12px;'><img src='{{GET:PagePath}}/themes/{{GET:PageTheme}}/images/user.gif' alt='User'></td>
      <td valign='top' style='padding-top: 4px; padding-right: 12px;white-space: nowrap'>{{GET:UserName}}</td>
