...
<html lang="en">
  ...
  <body {{GET:OnLoad}}>
    ...
    <div class="container">
		<form class="form-signin" name="SumoRegistration" method="POST" action="?sumo_action=regconfirmed">
        	<h2 class="form-signin-heading">Register</h2>
			
			{{LANG:ConfirmRegistrationInfo}}
			
			<input type="text" class="input-block-level" disabled value="{{GET:ConfirmRegUser}}" />
			<input type="text" class="input-block-level" disabled value="{{GET:ConfirmRegEmail}}" />
