...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>POTWECH — Lost password</title>
  ...
  <body {{GET:OnLoad}}>
    ...
    <div class="container">
		<form class="form-signin" name="SumoPasswordLost" method="POST" action="?sumo_action=pwdlostconfirmed">
        	<h2 class="form-signin-heading">Lost Password</h2>

			{{LANG:PasswordLostInfo}}
			{{GET:Message}}
			
			<input type="text" name="reg_email" class="input-block-level" placeholder="E-Mail" />
