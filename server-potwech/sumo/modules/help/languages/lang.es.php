...
"InfoDetails"    => "<table>\n"
				   ...
				   ."<tr><td align='right' style='padding-right:10px'><b>release</b>:</td>"
				   ."<td style='width:100%'>".date($SUMO['config']['server']['date_format'], SUMO_UPDATED)."</td>"
				   ."</tr>\n"
				   ."<tr><td style='text-align:right;vertical-align:top;padding:10px'><b>Platform:</td>"
				   ...
				   ."</table>"
				   ."<hr width='300' size='1'>"
				   ."&copy; 2003-".date("Y")." by Basso Alberto. Todos los derechos reservados.<br>"
				   ."SUMO Access Manager y SUMO logo son de Basso Alberto marca registrada\n"
				   ."<br><br>\n"
...
"CreditsDetails"	 =>  'I would like to give special thanks again everyone for helping to make this software better and easier for everyone:<br><br>'
						...
						.'<a href="mailto:fcampoli@runningroup.it">Federico Campoli</a> - PostgreSQL support<br>'
...
"AuthorDetails"  => "<table>\n"
				   ...
				   ."</td>"
				   ."<td style='padding-left: 10px; vertical-align: top; width: 100%; white-space: nowrap;' >"
				   ."<pre>"
