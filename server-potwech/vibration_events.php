...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>POTWECH - Vibration Detection</title>
  ...
  <body onLoad="init()">
    ...
    <div class="container">
	  ...
	  <!--<div id="chart" style="height:400px;width:800px; "></div>-->
	   <table>
		   ...
		   <tr>
			   <td valign="top"><img src="./assets/img/shake.png"><h3>Vibration detection</h3><p id="data"></p></td>
	...
	function getLightEvents(){
		$.getJSON("../rest/index.php/parcel_vibration-events/"+$_GET(['pid']), function (json) {
					if(json.features[0].properties.vibration){
						var res='<p>Occurences when the package exposed to strong vibrations:</p>';
						res=res+'<table border="1">';
						res=res+'<colgroup><col width="50"><col width="250"><col width="100"></colgroup>';
						res=res+'<tr><td>Occurrence</td><td>Time of occurrence</td><td>Vibration intensity</td></tr>';
						for (var i=0;i<json.features.length;i++){
							...
							//Ugly indexing...
							res=res+'<tr>'+'<td>'+(i+1)+'</td>'+'<td>'+timestamp.toGMTString()+'</td>'+'<td>'+json.features[i].properties.vibration+'</td>'+'</tr>';
