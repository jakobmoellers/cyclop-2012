...
<html lang="en">
  <head>
	  ...
	  ?>
    <meta charset="utf-8">
    <title>POTWECH - Light Detection</title>
  ...
  <body onLoad="init()">
    ...
    <div class="container">
	  ...
	  <!--<div id="chart" style="height:400px;width:800px; "></div>-->
	   <table>
		   ...
		   <tr>
			   <td valign="top"><img src="./assets/img/sun.svg"><h3>Light detection</h3><p id="data"></p></td>
	...
	function getLightEvents(){
		//console.log('data');
		//console.log("../rest/index.php/parcel_light-events/"+$_GET(['pid']));
		$.getJSON("../rest/index.php/parcel_light-events/"+$_GET(['pid']), function (json) {
					if(json.features[0].properties.light){
